...
public class StoryManager {
    ...
    private boolean musicStarted = false; // Флаг для отслеживания запуска музыки
    ...
    public void loadStory() {
        ...
        scene3.addDialog("Hiro", "It's pretty chill. Good atmosphere, and their pastries are amazing. It would be cool to actually talk outside of all this homework stress.");
        ...
        StoryScene scene7 = new StoryScene(
            ...
            new String[]{"Hiro/depression.png"}
        );
        ...
        scene8.addDialog("Hiro", "So, [Ваше имя], what do you usually do for fun outside of classes?");
        ...
        scene9.addDialog("Hiro", "This one’s been with me for years. Wanna try playing something together?");
        ...
        StoryScene scene14 = new StoryScene(
            ...
            new String[]{"Hiro/learning_how_to_play.png"}
        );
        ...
        StoryScene scene18 = new StoryScene(
            "hiro_room_posters.jpg",
            "You notice various music posters on the walls that you hadn't paid attention to before.",
            new String[]{"Hiro/amazed2.png"}
        );
        ...
        StoryScene scene35 = new StoryScene(
            ...
            new String[]{"Hiro/concentrated.png"}
        );
        ...
        StoryScene scene38 = new StoryScene(
            ...
            new String[]{"Hiro/happy_tired.png"}
        );
        ...
        StoryScene scene44 = new StoryScene(
            ...
            new String[]{"Hiro/thoughtful_window.png"}
        );
        ...
        StoryScene scene49 = new StoryScene(
            "hiro_room_intense.jpg",
            "Time seems to slow as your eyes meet and hold.",
            new String[]{"Hiro/intense_gaze.png"}
        );
        ...
        StoryScene scene50 = new StoryScene(
            "hiro_room_gentle.jpg",
            "A sweet, shy energy fills the space between you.",
            new String[]{"Hiro/gentle_smile.png"}
        );
        ...
        StoryScene scene52 = new StoryScene(
            ...
            new String[]{"Hiro/thoughtful.png"}
        );
...
// Scene 60: Suggestion for breakfast together
        ...
        scene60.addDialog("Narrator", "As you both prepare to leave, there's an easy comfort between you, as if this is something you've done many times before.");
...
// Scene 88 - Agreement to be brave together
        StoryScene scene88 = new StoryScene(
            ...
            new String[]{"Hiro/determined.png"}
        );
...
// Scene 95 - Final scene - The beginning of something beautiful
    ...
    public void goToScene(int sceneIndex) {
        if (sceneIndex >= 0 && sceneIndex < scenes.size) {
            ...
            // Остановить текущую музыку перед переходом
            if (bgMusic != null && bgMusic.isPlaying()) {
                bgMusic.stop();
            }

            // Запускать музыку только для сцен 10, 11, 12
            if(sceneIndex == 1){
            ...
            {
                playSceneMusic("music/guitar1.mp3"); // Замените на нужный файл
            } else if (sceneIndex == 11) {
                playSceneMusic("music/guitar2.mp3"); // Замените на нужный файл
            } else if (sceneIndex == 12) {
                playSceneMusic("music/guitar3.mp3"); // Замените на нужный файл
            }
        }
    }
    ...
    public void restart() {
        currentSceneIndex = 0;
        currentDialogIndex = 0;
        // При рестарте музыка не запускается автоматически, если вы хотите - добавьте вызов playSceneMusic
    }
